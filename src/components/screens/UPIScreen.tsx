        ...
        <div className="grid grid-cols-2 card-gap">
          ...
          <button onClick={onHistoryClick} className="h-auto py-4 flex flex-col items-center icon-text-gap rounded-xl bg-muted ring-1 ring-border active:scale-[0.98] transition-all hover:ring-primary hover:shadow-sm cursor-pointer">
            ...
            <button
              ...
              className={"h-auto py-4 flex flex-col items-center icon-text-gap rounded-xl bg-muted ring-1 ring-border active:scale-[0.98] transition-all hover:ring-primary hover:shadow-sm cursor-pointer"}
            >
            ...
            <button
              ...
              className={"col-span-2 h-auto py-4 flex flex-col items-center icon-text-gap rounded-xl bg-muted ring-1 ring-border active:scale-[0.98] transition-all hover:ring-primary hover:shadow-sm cursor-pointer"}
            >
